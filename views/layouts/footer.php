            ...
            <div class="container"> 
                <div class="row justify-content-center pt-6 sm-pt-40px text-sm-start text-center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6 md-mb-30px">
                        <a href="<?php echo base_url(); ?>/" class="footer-logo mb-20px d-inline-block"> 
                            <img src="<?php echo base_url(); ?>/assets/img/logo/logo-02.webp" alt="">
                        </a>
                        <p class="fs-17 mx-auto xs-w-90">TSL metroline is a BOC licensed to operate modern and efficient bus service. </p> 
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-5 offset-xl-1 offset-md-0 offset-sm-1 md-mb-30px">
                        <span class="fs-18 d-block text-white fw-500 mb-10px">What we do</span>
                        <ul>
                            <li><a href="<?php echo base_url(); ?>/urban_mass">Urban Mass Transit</a></li>
                            <li><a href="<?php echo base_url(); ?>/intercity_services">Intercity Services</a></li>                                       
                            <li><a href="<?php echo base_url(); ?>/regional_bus">Regional Bus Services</a></li>                                       
                            <li><a href="<?php echo base_url(); ?>/bus_charter">Bus Charter</a></li>   
                        </ul>
                    </div>
                    <!-- end footer column -->
                    <!-- start footer column -->
                    <div class="col-lg-3 col-md-4 col-sm-5 offset-md-0 offset-sm-1 order-5 order-md-3 xs-mb-30px">
                        ...
                        <a href="tel:+2348 0022 558 75" class="mb-15px d-inline-block">+2348 000 000 865</a>
                    ...
                    <div class="col-lg-3 col-md-10 col-sm-6 text-md-center text-lg-start order-last order-sm-4">
                        ...
                        <div class="d-inline-block w-100 newsletter-style-02 position-relative mb-15px">
                            <form action="email-templates/subscribe-newsletter" method="post" class="position-relative w-100">
