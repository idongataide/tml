            ...
            <div class="col-xl-11 col-lg-11 col-md-12 offset-lg-1">
                <blockquote class="border-4 border-start text-dark-gray fw-500 border-color-red ps-40px">
                    <p data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }' class="fs-22 mb-15px">
                        ...
                        empower our team to Be More every day, turning TML into not just a
            ...
            <div class="row">
                <div class="col-lg-12" >
                    <div data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <p class="mb-0">At TML, we believe in the power of potential. We are more than just a company; we are a community dedicated to helping you 'Be More' in every aspect of life. Our purpose is to empower and inspire our employees' personal and professional growth throughout their careers."</p>
                    </div>
                </div>                    
            </div>
        </div> 
                        ...
                        <div class="col-lg-6 cover-background overflow-visible h-100 md-h-500px" style="background-image: url('<?php echo base_url(); ?>/assets/img/careers/staffs.jpg')">
                            ...
                            <div class="position-absolute right-0px bottom-minus-1px">
                                <div class="vertical-title-center">
                                    <div class="title fw-700 fs-15 alt-font ls-2px text-uppercase text-dark-gray bg-white pt-30px pb-30px ps-10px pe-10px">
