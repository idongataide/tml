<section class="page-title-big-typography breadcrumbs bg-dark-gray ipad-top-space-margin cover-background md-py-0" style="background-image: url(<?php echo base_url(); ?>/assets/img/banner/breadcrumb/tml-services.webp)"> 
            ...
            <div class="container">
                <div class="row align-items-center mb-5 sm-mb-30px text-center text-lg-start" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="col-lg-5 md-mb-30px"> 
                         <h3 class="fw-600 text-dark-gray ls-minus-2px mb-0">Our Core Business Services</h3>
                    </div> 
                    <div class="col-lg-4 offset-xl-1 last-paragraph-no-margin md-mb-30px"> 
                         <p>TSL Metroline provides Urban Mass Transit, Intercity, and Regional Bus services with High-Capacity, Medium-Capacity buses, and Coaches.</p>
                    </div> 
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                            <div class="position-relative">
                                                <a href="<?php echo base_url(); ?>/services/urban_mass"><img src="<?php echo base_url(); ?>/assets/img/service/reg2.jpg" alt=""></a>
                                            </div>
                                            <div class="bg-white">
                                                <div class="ps-40px pe-40px pt-30px pb-30px text-center">
                                                    <a href="urban_mass" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Urban Mass Transit</a>
                                                    <p>Ensuring that you get to your destinations smoothly and on time.</p> 
                                                </div> 
                                                <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                    <a href="<?php echo base_url(); ?>/services/urban_mass" class="btn btn-link shadow-0 btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                                        <span>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                            ...
                                            <div class="bg-white">
                                                <div class="ps-40px pe-40px pt-30px pb-30px text-center">
                                                    <a href="intercity_services" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Intercity Services</a>
                                                    <p>Connecting you to major cities with maximum ease and comfort</p> 
                                                </div> 
                                                <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                    <a href="<?php echo base_url(); ?>/services/intercity_services" class="btn shadow-0 btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                                        <span>
                                                            <span class="btn-text">Explore services</span>
                                                            <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                                                            <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="services-box-style-03 last-paragraph-no-margin border-radius-4px overflow-hidden">
                                            <div class="position-relative">
                                                <a href="<?php echo base_url(); ?>/services/bus_charter"><img src="<?php echo base_url(); ?>/assets/img/service/3.webp" alt=""></a>
                                                </div>
                                            <div class="bg-white">
                                                <div class="ps-40px pe-40px pt-30px pb-30px text-center">
                                                    <a href="<?php echo base_url(); ?>/services/bus_charter" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Bus Charter Services</a>
                                                    <p>Designed to offer you the flexibility and convenience you require.</p> 
                                                </div> 
                                                <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                    <a href="<?php echo base_url(); ?>/services/bus_charter" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                                        <span>
                                                            <span class="btn-text">Explore services</span>
                                                            <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                                                            <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
            ...
            <div class="row position-relative">
                <div class="col swiper swiper-width-auto feather-shadow text-center" 
                    ...
                    <div class="swiper-wrapper marquee-slide">
                        <!-- start client item -->
                        <div class="swiper-slide">
                            <div class="fs-22 sm-fs-22 alt-font ls-minus-05px text-dark-gray">
                                <span class="w-10px h-10px border border-radius-100 border-color-base-color d-inline-block ms-50px me-50px md-ms-30px md-me-30px"></span>
                                    Safety and Security:  Prioritize safety of workers and passengers.
                            </div>
                        </div>                               
                        <div class="swiper-slide">
                            <div class="fs-22 sm-fs-22 alt-font ls-minus-05px text-dark-gray">
                                <span class="w-10px h-10px border border-radius-100 border-color-base-color d-inline-block ms-50px me-50px md-ms-30px md-me-30px"></span>
                                    Zero-Tolerance Policies: Alcohol, drugs, and speeding.
                            </div>
                        </div>                             
                        <div class="swiper-slide">
                            <div class="fs-22 sm-fs-22 alt-font ls-minus-05px text-dark-gray">
                                <span class="w-10px h-10px border border-radius-100 border-color-base-color d-inline-block ms-50px me-50px md-ms-30px md-me-30px"></span>
                                    Weekly Safety Meetings:  Regular training for employees.
                            </div>
                        </div>                         
                        <div class="swiper-slide">
                            <div class="fs-22 sm-fs-22 alt-font ls-minus-05px text-dark-gray">
                                <span class="w-10px h-10px border border-radius-100 border-color-base-color d-inline-block ms-50px me-50px md-ms-30px md-me-30px"></span>
                                 Proactive Maintenance:  Preventive upkeep of assets.
                            </div>
                        </div>                            
                        <div class="swiper-slide">
                            <div class="fs-22 sm-fs-22 alt-font ls-minus-05px text-dark-gray">
                                <span class="w-10px h-10px border border-radius-100 border-color-base-color d-inline-block ms-50px me-50px md-ms-30px md-me-30px"></span>
                                  Journey Management:  On-board monitoring and compliance checks.
                            </div>
                        </div>                          
                    </div> 
                </div>  
